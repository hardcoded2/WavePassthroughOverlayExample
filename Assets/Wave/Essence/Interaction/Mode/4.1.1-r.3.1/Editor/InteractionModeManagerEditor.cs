...
namespace Wave.Essence.Interaction.Mode.Editor
{
	...
	public static class InteractionModeManagerSettings
	{
		...
		const string kInteractionModeManagerAsset = "Assets/Wave/Essence/Interaction/Mode/InteractionModeManager.asset";
		public static void UpdateManagerAsset(bool autoAddManager)
		{
			InteractionModeManagerAsset asset = null;
			if (File.Exists(kInteractionModeManagerAsset))
			{
				asset = AssetDatabase.LoadAssetAtPath(kInteractionModeManagerAsset, typeof(InteractionModeManagerAsset)) as InteractionModeManagerAsset;
			...
			else
			{
				...
				asset.autoAddManager = autoAddManager;
				AssetDatabase.CreateAsset(asset, kInteractionModeManagerAsset);
			}
			AssetDatabase.SaveAssets();
			Debug.Log("UpdateManagerAsset() " + kInteractionModeManagerAsset + ", autoAddManager: " + asset.autoAddManager);
		}
		public static bool ShouldAutoAddManager()
		{
			UpdateManagerAsset(AutoAddManager);
			InteractionModeManagerAsset asset = AssetDatabase.LoadAssetAtPath(kInteractionModeManagerAsset, typeof(InteractionModeManagerAsset)) as InteractionModeManagerAsset;
